...
/* COMMANDS */
#define SI4710_CMD_POWER_UP 0x01 ///< Power up device and mode selection. Modes include FM transmit and
...
#define SI4713_PROP_TX_COMPONENT_ENABLE 0x2100 ///< Enable transmit multiplex signal components. Default has pilot and
         ///< L-R enabled.
#define SI4713_PROP_TX_AUDIO_DEVIATION 0x2101 ///< Configures audio frequency deviation level. Units are in 10 Hz
         ///< increments. Default is 6285 (68.25 kHz).
#define SI4713_PROP_TX_PILOT_DEVIATION 0x2102 ///< Configures pilot tone frequency deviation level. Units are in 10
         ///< Hz increments. Default is 675 (6.75 kHz)
#define SI4713_PROP_TX_RDS_DEVIATION 0x2103 ///< Configures the RDS/RBDS frequency deviation level. Units are in 10
         ///< Hz increments. Default is 2 kHz.
#define SI4713_PROP_TX_LINE_LEVEL_INPUT_LEVEL 0x2104 ///< Configures maximum analog line input level to the LIN/RIN pins to
         ///< reach the maximum deviation level pro- grammed into the audio
         ///< deviation property TX Audio Deviation. Default is 636 mVPK.
#define SI4713_PROP_TX_LINE_INPUT_MUTE 0x2105 ///< Sets line input mute. L and R inputs may be indepen- dently muted.
...
#define SI4713_PROP_TX_ACOMP_THRESHOLD 0x2201 ///< Sets the threshold level for audio dynamic range control. Default
         ///< is –40 dB.
#define SI4713_PROP_TX_ATTACK_TIME 0x2202 ///< Sets the attack time for audio dynamic range control. Default is 0
         ///< (0.5 ms).
#define SI4713_PROP_TX_RELEASE_TIME 0x2203 ///< Sets the release time for audio dynamic range control. Default is
         ///< 4 (1000 ms).
...
#define SI4713_PROP_TX_ASQ_INTERRUPT_SOURCE 0x2300 ///< Configures measurements related to signal quality met- rics.
         ///< Default is none selected.
#define SI4713_PROP_TX_ASQ_LEVEL_LOW 0x2301 ///< Configures low audio input level detection threshold. This
         ///< threshold can be used to detect silence on the incoming audio.
#define SI4713_PROP_TX_ASQ_DURATION_LOW 0x2302 ///< Configures the duration which the input audio level must be below
         ///< the low threshold in order to detect a low audio condition.
#define SI4713_PROP_TX_AQS_LEVEL_HIGH 0x2303 ///< Configures high audio input level detection threshold. This
         ///< threshold can be used to detect activity on the incoming audio.
#define SI4713_PROP_TX_AQS_DURATION_HIGH 0x2304 ///< Configures the duration which the input audio level must be above
...
#define SI4713_PROP_TX_RDS_PS_REPEAT_COUNT 0x2C04 ///< Number of times to repeat transmission of a PS message before
         ///< transmitting the next PS mes- sage.
#define SI4713_PROP_TX_RDS_MESSAGE_COUNT 0x2C05 ///< Number of PS messages in use.
#define SI4713_PROP_TX_RDS_PS_AF 0x2C06 ///< RDS Program Service Alternate Fre- quency. This provides the
